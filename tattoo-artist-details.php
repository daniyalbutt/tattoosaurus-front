<?php include 'include/header.php'; ?>
        <title>Tattoo Artists Details - Tattoosaurus</title>
    </head>
    <body data-barba="wrapper">
        <main data-barba="container" data-barba-namespace="tattoo-artist-details">
                        ...
                        <div class="col-xl-3">
                            <div class="artist-social">
                                ...
                                <ul class="artist-list">
                                    <li><p><i class="fa-solid fa-calendar"></i> Availability</p></li>
                                    <li><p><i class="fa-solid fa-paper-plane"></i> Responds within 2 days</p></li>
                                    <li><p><i class="fa-solid fa-comment"></i> Chat With Me</p></li>
                                    <li><p><i class="fa-solid fa-percent"></i> Hourly Rate - $100</p></li>
                                    <li><p><i class="fa-solid fa-circle-question"></i> FAQ’s</p></li>
                                </ul>
