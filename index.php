                ...
                <div class="row">
                        ...
                        <div class="gallery-slider slick-slider">
                            <div class="gallery-box">
                                <div class="gallery-box-inner">
                                    <a href="tattoo-artist-details.php">
                    ...
                    <div class="col-md-12">
                        <div class="text-center mt-4">
                            <a href="" class="btn btn-gradient">VIEW ALL TATTOOS</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="artist-slider slick-slider">
                            <div class="artist-wrapper">
                                <div class="artist-box">
                                    <a href="tattoo-artist-details.php">
                                        <img src="img/artist-img-1.png" alt="">
                                        <div class="artist-lower">
                                            <h6>Los Angeles</h6>
                                            <h4>Katrina DaSilva</h4>
                                            <p>Specializing in blackwork and geometric designs</p>
                                            <div class="star-container d-none">
                                                <p>Rating</p>
                            ...
                            <div class="artist-wrapper">
                                <div class="artist-box">
                                    <a href="tattoo-artist-details.php">
                                        <img src="img/artist-img-2.png" alt="">
                                        <div class="artist-lower">
                                            <h6>Los Angeles</h6>
                                            <h4>Katrina DaSilva</h4>
                                            <p>Specializing in blackwork and geometric designs</p>
                            ...
                            <div class="artist-wrapper">
                                <div class="artist-box">
                                    <a href="tattoo-artist-details.php">
                                        <img src="img/artist-img-3.png" alt="">
                                        <div class="artist-lower">
                                            <h6>Los Angeles</h6>
                                            <h4>Katrina DaSilva</h4>
                                            <p>Specializing in blackwork and geometric designs</p>
                                            ...
                                            <div class="event-box">
                                                <a href="event-details.php">
                                                    ...
                                                    <div class="event-lower">
                                                        <h6>April 28, 2026 – 10:00 AM PDT</h6>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="section-heading text-center">
                            ...
                            <p>If you have any questions about Tattoosaurus, visit our FAQ page to get detailed answers.</p>
                            <a href="faqs.php" class="btn btn-gradient">VIEW FAQ</a>
                        </div>
                    </div>
                </div>
